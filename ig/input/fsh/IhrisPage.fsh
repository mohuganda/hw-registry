...
* extension[section][0].extension[field][6].valueString = "Practitioner.extension:father"
* extension[section][0].extension[field][7].valueString = "Practitioner.extension:mother"
* extension[section][0].extension[field][8].valueString = "Practitioner.extension:nationality"
* extension[section][0].extension[field][9].valueString = "Practitioner.extension:birthPlace"
...
* extension[section][2].extension[field][0].valueString = "Practitioner.extension:address"
* extension[section][2].extension[field][1].valueString = "Practitioner.telecom"
* extension[section][2].extension[field][2].valueString = "Practitioner.extension:emergency"
...
* extension[section][6].extension[resource].extension[column][3].extension[header].valueString = "Actions"
* extension[section][6].extension[resource].extension[column][3].extension[field].valueString = "_action"
* extension[section][6].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/ihris-emergency/emergency?practitioner=FHIRID"
* extension[section][6].extension[resource].extension[action][0].extension[text].valueString = "Add Emergency Contact"
...
* extension[section][6].extension[resource].extension[action][1].extension[link].valueString = "/resource/view/emergency/ITEMID"
